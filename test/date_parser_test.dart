...
void main() {
  ...
  test('valid ISO 8601 (-yy-mm)', () {
    const d = UniversalTimestamp('-03-12');
    expect(d.parseValue()?.toIso8601String(), '2003-12-01T00:00:00.000Z');
  });
