...
Map<String, TestFx> geoRssTests() {
  return {
    'geo_line.xml': (r) => r.items.first.geo!.line == '45.256 -110.45 46.46 -109.48 43.84 -109.86',
    'geo_polygon.xml': (r) => r.items.first.geo!.polygon == '45.256 -110.45 46.46 -109.48 43.84 -109.86 45.256 -110.45',
    'geo_box.xml': (r) => r.items.first.geo!.box == '42.943 -71.032 43.039 -69.856',
    'geo_feature_typetag.xml': (r) => r.items.first.geo!.featureTypeTag == 'city',
    'geo_relationshiptag.xml': (r) => r.items.first.geo!.relationshipTag == 'is-centered-at',
    'geo_featurename.xml': (r) => r.items.first.geo!.featureName == 'Podunk',
    'geo_elev.xml': (r) => r.items.first.geo!.elev == '313',
    'geo_floor.xml': (r) => r.items.first.geo!.floor == '2',
    'geo_radius.xml': (r) => r.items.first.geo!.radius == '500',
  };
}
