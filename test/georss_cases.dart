...
Map<String, TestFx> geoRssTests() {
  return {
    ...
    'geo_polygon.xml': (r) => r.entries!.first.georss!.polygon == '45.256 -110.45 46.46 -109.48 43.84 -109.86 45.256 -110.45',
...
Map<String, TestFxAtom> geoAtomTests() {
  return {
    ...
    'geo_atom_polygon.xml': (r) => r.entries!.first.georss!.polygon == '45.256 -110.45 46.46 -109.48 43.84 -109.86 45.256 -110.45',
